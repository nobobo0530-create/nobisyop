...
【最重要①：型番・モデル名の読み取り】
写真に内側ラベル・タグ・刻印・品質表示タグが写っている場合は必ず確認してください。
- model_number: 英数字のコード（例: M51258, BA0509, GG0034S）
- model_name: 人が呼ぶ名前（例: Neverfull MM, Musette Salsa, Ophidia GG）
高級ブランド対応例:
  Louis Vuitton → model_number: M51258, model_name: Musette Salsa
  Gucci → model_number: 499621, model_name: Ophidia GG Medium
  Chanel → model_number: A01112, model_name: Classic Flap Medium
  Hermes → model_number: null, model_name: Birkin 30
  Prada → model_number: 1BA049, model_name: Galleria Medium
※写真から読み取れない場合はnullにする（推測で入れない）
