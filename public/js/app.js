...
{
  "product_name": "商品名（40文字以内、メルカリ出品用。高級ブランドは型名を含める）",
  "brand": "ブランド名",
  "model_number": "型番・品番・モデル名（例：M41526、Neverfull MM、GG Supreme、BA0509）。タグ・刻印・内側ラベルから読み取る。不明はnull",
...
【最重要：型番・モデル名の読み取り】
ルイヴィトン・グッチ・シャネル・エルメス・プラダ・コーチ・バレンシアガなど高級ブランドは
必ずタグ・刻印・内側ラベル・品質表示タグから型番/モデル名を探してください。
例: Louis Vuitton → M41526（Neverfull MM）/ Gucci → 401231（GGキャンバストート）
